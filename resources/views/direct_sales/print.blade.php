        ...
        <table>
            <tr>
                ...
                <td width="40%" style="vertical-align: top; text-align: right;">
                    <div style="font-size: 22px; font-weight: bold; white-space: nowrap;">NOTA PENJUALAN</div>
                    <div style="font-size: 14px; font-weight: bold; margin-top: 6px;">No: {{ $directSale->invoice_number }}</div>
                    <div style="font-size: 13px; font-weight: bold; margin-top: 2px;">Tgl: {{ \Carbon\Carbon::parse($directSale->sale_date)->format('d F Y') }}</div>
                </td>
            </tr>
        </table>
        ...
        <table class="info-table">
            <tr>
                <td width="48%" style="vertical-align: top; padding-right: 15px;">
                    <div style="font-size: 12px; font-weight: bold; text-transform: uppercase; margin-bottom: 6px;">Pembayaran</div>
                    <div style="font-size: 14px; font-weight: bold; margin-bottom: 10px;">{{ strtoupper($directSale->payment_method ?? 'TUNAI') }}</div>
