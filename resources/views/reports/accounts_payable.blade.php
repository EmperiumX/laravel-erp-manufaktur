<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Laporan Hutang Dagang') }}</h2>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="bg-white shadow-sm sm:rounded-lg p-6 border-l-4 border-red-500">
                    ...
                    <p class="text-2xl font-bold text-red-700">Rp {{ number_format($totalHutang, 0, ',', '.') }}</p>
                </div>
                ...
                <div class="bg-white shadow-sm sm:rounded-lg p-6 border-l-4 border-orange-500">
                    <p class="text-sm text-gray-500">Jatuh Tempo</p>
                    <p class="text-2xl font-bold text-orange-700">{{ $overdue->count() }} invoice</p>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <table id="apTable" class="w-full table-auto border-collapse border border-gray-300 text-sm">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr class="{{ $inv->is_overdue ? 'bg-red-50' : '' }}">
                                ...
                                <td class="border px-4 py-2">{{ $inv->supplier->name ?? '-' }}</td>
    ...
    <script>$(document).ready(function() { $('#apTable').DataTable(); });</script>
</x-app-layout>
