                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6 w-full overflow-hidden">
                    <div class="flex space-x-8 overflow-x-auto whitespace-nowrap w-full no-scrollbar pb-1 pt-1">
                        ...
                        @hasanyrole('Superadmin|Admin|Sales')
                            ...
                            <x-nav-link :href="route('direct-sales.index')" :active="request()->routeIs('direct-sales.*')">
                                {{ __('Penjualan') }}
                            </x-nav-link>
                        @endhasanyrole
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @hasanyrole('Superadmin|Admin|Sales')
                ...
                <x-responsive-nav-link :href="route('direct-sales.index')" :active="request()->routeIs('direct-sales.*')">
                    {{ __('Penjualan') }}
                </x-responsive-nav-link>
            @endhasanyrole
        </div>
