...
<body>
    <div class="main-container">
        ...
        <table>
            <tr>
                ...
                <td width="42%" style="vertical-align: top; text-align: right;">
                    <div style="font-size: 20px; font-weight: bold; white-space: nowrap; letter-spacing: 1px;">SURAT JALAN</div>
                    <div style="font-size: 13px; font-weight: bold; margin-top: 3px; white-space: nowrap;">No: {{ $consignment->shipment_number }}</div>
        ...
        <table class="info-table">
            <tr>
                <td width="48%" style="vertical-align: top; padding-right: 15px;">
                    <div style="font-size: 11px; font-weight: bold; text-transform: uppercase; margin-bottom: 3px; letter-spacing: 0.5px;">No. Pesanan / PO</div>
                    <div style="font-size: 13px; font-weight: bold; margin-bottom: 6px;">{{ $consignment->invoice?->invoice_number ?? '-' }}</div>

                    <div style="font-size: 11px; font-weight: bold; text-transform: uppercase; margin-bottom: 2px; letter-spacing: 0.5px;">Pengirim / Outlet</div>
                ...
                <td width="52%" style="vertical-align: top; padding-left: 10px;">
                    <div style="font-size: 11px; font-weight: bold; text-transform: uppercase; margin-bottom: 3px; letter-spacing: 0.5px;">Dikirimkan Ke Alamat</div>
        ...
        <table class="items-table">
            ...
            <tfoot>
                <tr>
                    <td colspan="3" style="text-align: right; font-weight: bold; padding: 5px 4px; border-top: 2px solid #000; border-bottom: 2px solid #000;">Total Jumlah</td>
