        ...
        <table>
            <tr>
                <td width="58%" style="vertical-align: top;">
                    <div style="font-size: 20px; font-weight: bold; letter-spacing: 0.8px; color: #b91c1c;">NEW CITRA INDONESIA</div>
                    <div style="font-size: 13px; font-weight: bold; margin-top: 4px; line-height: 1.4; color: #000;">
                ...
                <td width="42%" style="vertical-align: top; text-align: right;">
                    <div style="font-size: 24px; font-weight: bold; white-space: nowrap; letter-spacing: 1px; color: #a81a1a;">SURAT JALAN</div>
                    <div style="font-size: 14px; font-weight: bold; margin-top: 5px; white-space: nowrap; color: #000;">No: {{ $consignment->shipment_number }}</div>
                    <div style="font-size: 13px; font-weight: bold; margin-top: 3px; white-space: nowrap; color: #000;">Tgl: {{ \Carbon\Carbon::parse($consignment->shipment_date)->format('d M Y') }}</div>
                </td>
            </tr>
        </table>
        ...
        <table class="info-table">
            <tr>
                <td width="48%" style="vertical-align: top; padding-right: 15px;">
                    <div style="font-size: 12px; font-weight: bold; text-transform: uppercase; margin-bottom: 5px; letter-spacing: 0.5px; color: #b91c1c;">No. Pesanan / PO</div>
                    <div style="font-size: 14px; font-weight: bold; margin-bottom: 12px;">{{ $consignment->invoice?->invoice_number ?? '-' }}</div>

                    <div style="font-size: 12px; font-weight: bold; text-transform: uppercase; margin-bottom: 3px; letter-spacing: 0.5px; color: #b91c1c;">Pengirim / Outlet</div>
                ...
                <td width="52%" style="vertical-align: top; padding-left: 10px;">
                    <div style="font-size: 12px; font-weight: bold; text-transform: uppercase; margin-bottom: 5px; letter-spacing: 0.5px; color: #b91c1c;">Dikirimkan Ke Alamat</div>
