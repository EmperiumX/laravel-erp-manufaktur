        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <!-- Form Action mengarah ke route store, method POST -->
                    <form action="{{ route('suppliers.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="w-full border-gray-300 rounded-md shadow-sm" required placeholder="Contoh: PT. Bumbu Alam">
                        </div>

                        <!-- Input Kontak Person -->
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Kontak Person</label>
                            <input type="text" name="contact_person" class="w-full border-gray-300 rounded-md shadow-sm" placeholder="Contoh: Bpk. Budi">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="address" rows="3" class="w-full border-gray-300 rounded-md shadow-sm" placeholder="Contoh: Jl. Merdeka No. 10, Semarang"></textarea>
                        </div>
